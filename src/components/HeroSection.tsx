...
export default function HeroSection() {
  return (
    <section
      id="hero"
      className="relative min-h-[85vh] md:min-h-screen flex flex-col justify-center pt-8 pb-12 md:pt-28 md:pb-16 overflow-hidden bg-brand-offwhite"
    >
      {/* ── Content ────────────────────────────── */}
      <div className="relative z-10 max-w-7xl mx-auto w-full px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className="flex flex-col gap-6 md:gap-8 mt-2 md:mt-0">
            {/* Badge */}
            <motion.div
            ...
            >
              <span className="bg-brand-white border border-brand-slate-light px-3 py-1.5 rounded-full text-[10px] sm:text-xs font-semibold tracking-[0.1em] uppercase text-brand-slate-dark flex items-center gap-2 shadow-sm">
            ...
            <motion.h1
              ...
              className="text-4xl sm:text-4xl md:text-5xl lg:text-[4rem] font-bold leading-[1.1] tracking-tight font-[var(--font-playfair)] text-brand-charcoal"
            >
              Door Seal - Premium Hardware by{" "}
              <span className="text-gradient-brass">Sardar Manufactures, Rajkot</span>
            </motion.h1>
            ...
            >
              ...
              <motion.a
                whileTap={{ scale: 0.96 }}
                href="#contact"
                aria-label="Request a wholesale bulk quote for Door Seal products"
              ...
              <motion.a
                whileTap={{ scale: 0.96 }}
                href="#catalog"
                aria-label="Download the full Door Seal product catalog PDF"
